  ...
  return (
    <>
      <nav className="container flex items-center justify-between px-4 md:px-9 lg:px-14 xl:px-20 py-5 lg:py-8 font-Poppins">
        ...
        <div
          id="dropdown"
          className={`fixed md:relative flex-1 md:ml-8 lg:ml-14 xl:ml-20 top-16 md:top-0.5 left-1/2 -translate-x-1/2 md:left-0 w-5/6 md:w-auto h-72 md:h-auto px-5 sm:px-0 py-8 sm:py-0 bg-DarkViolet md:bg-transparent z-50 transform ${
            isOpen
